    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="footer--image">
          <img src="./img/saiLogo.png" alt="saiLogo" />
        </div>
        <div className="footer--items">
          <ul>
            ...
            <li>
               {!isHomePage ? (
                        <a href="/about" className="navbar--content">About Me</a>
                    ) : 
                    <Link 
                    activeClass="navbar--active-content" 
                    spy={true} 
            ...
            <li>
                    {!isHomePage ? (
                        <a href="/projects" className="navbar--content">Portfolio</a>
                    ) : 
                    <Link 
                    activeClass="navbar--active-content" 
                    spy={true} 
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/saibalaji.nagarajan"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/saibalaji-n/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with React.js, a tutorial from <a href="https://www.youtube.com/@howtobecomeadeveloper">How to Be A Developer</a> , and ChatGPT</p>
        <div className="footer--social--icon">
        </div>
      </div>
    </footer>
